...
exports.hIncrBy = exports.zIncrBy = exports.renamenx = exports.rename = exports.keys = exports.pttl = exports.ttl = exports.persist = exports.expireAt = exports.expire = exports.exists = exports.del = exports.type = exports.rPushX = exports.rPush = exports.rPop = exports.lTrim = exports.lSet = exports.lRem = exports.lPush = exports.lPop = exports.lIndex = exports.scan = exports.sIsMember = exports.zCount = exports.zRemRangeByScore = exports.zRem = exports.zAdd = exports.zRevRangeByScore = exports.zRangeByScore = exports.zScore = exports.zRank = exports.zRevRange = exports.zRange = exports.hMGet = exports.hRandField = exports.hKeys = exports.hVals = exports.hGetAll = exports.hDel = exports.hGet = exports.get = exports.hset = exports.hExists = exports.time = exports.urlGet = exports.urlGetCmd = exports.configure = exports.setDefaultSUToken = exports.Option = void 0;
exports.api = exports.xRead = exports.xRange = exports.lRange = exports.zScan = exports.hScan = exports.sScan = exports.zCard = exports.sCard = exports.xLen = exports.lLen = exports.hLen = exports.xDel = exports.xAdd = exports.hIncrByFloat = void 0;
...
var scan = function (Cursor, Match, Count, opt) {
    if (Count === void 0) { Count = 4096; }
    if (opt === void 0) { opt = exports.Option; }
    return Req(opt).get("".concat(opt.Urlbase || urlbase, "/SCAN-!null").concat(opt.paramString(), "?Cursor=").concat(Cursor, "&Match=").concat(encodeURIComponent(Match), "&Count=").concat(Count));
};
exports.scan = scan;
...
exports.xDel = xDel;
var hLen = function (Key, opt) {
    if (opt === void 0) { opt = exports.Option; }
    return Req(opt).get("".concat(opt.Urlbase || urlbase, "/HLEN-!").concat(Key).concat(opt.paramString()));
};
exports.hLen = hLen;
...
exports.xLen = xLen;
var sCard = function (Key, opt) {
    if (opt === void 0) { opt = exports.Option; }
    return Req(opt).get("".concat(opt.Urlbase || urlbase, "/SCARD-!").concat(Key).concat(opt.paramString()));
};
exports.sCard = sCard;
...
var sScan = function (Key, Cursor, Match, Count, opt) {
    if (Count === void 0) { Count = 4096; }
    if (opt === void 0) { opt = exports.Option.rspTypeMsgpack(); }
    return Req(opt).get("".concat(opt.Urlbase || urlbase, "/SSCAN-!").concat(Key).concat(opt.paramString(), "?Cursor=").concat(Cursor, "&Match=").concat(encodeURIComponent(Match), "&Count=").concat(Count));
};
exports.sScan = sScan;
var hScan = function (Key, Cursor, Match, Count, opt) {
    if (Count === void 0) { Count = 4096; }
    if (opt === void 0) { opt = exports.Option.rspTypeMsgpack(); }
    return Req(opt).get("".concat(opt.Urlbase || urlbase, "/HSCAN-!").concat(Key).concat(opt.paramString(), "?Cursor=").concat(Cursor, "&Match=").concat(encodeURIComponent(Match), "&Count=").concat(Count));
};
exports.hScan = hScan;
var zScan = function (Key, Cursor, Match, Count, opt) {
    if (Count === void 0) { Count = 4096; }
    if (opt === void 0) { opt = exports.Option.rspTypeMsgpack(); }
    return Req(opt).get("".concat(opt.Urlbase || urlbase, "/ZSCAN-!").concat(Key).concat(opt.paramString(), "?Cursor=").concat(Cursor, "&Match=").concat(encodeURIComponent(Match), "&Count=").concat(Count));
};
exports.zScan = zScan;
...
var xRead = function (Key, Count, Block, opt) {
    if (Count === void 0) { Count = 4096; }
    if (Block === void 0) { Block = "0ms"; }
    if (opt === void 0) { opt = exports.Option.rspTypeMsgpack(); }
    return Req(opt).get("".concat(opt.Urlbase || urlbase, "/XREAD-!").concat(Key).concat(opt.paramString(), "?Count=").concat(Count, "&Block=").concat(Block));
};
exports.xRead = xRead;
