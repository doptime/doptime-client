...
exports.newApi = exports.OptionClass = exports.Option = exports.zKey = exports.hKey = exports.lKey = exports.strKey = exports.setKey = exports.xKey = exports.renamenx = exports.rename = exports.pttl = exports.ttl = exports.persist = exports.expireAt = exports.expire = exports.exists = exports.del = exports.type = exports.keys = exports.scan = exports.time = exports.urlGet = exports.urlGetCmd = exports.msgpackDecode = void 0;
...
exports.strKey = stringKey_1.default;
...
var time = function (opt) {
    if (opt === void 0) { opt = Option_1.Option.setDataSource("default"); }
    return (0, http_1.default)(opt).get("".concat(opt.baseUrl, "/TIME-null?t=").concat(new Date().getTime()));
};
exports.time = time;
var scan = function (Cursor, Match, Count, opt) {
    if (Count === void 0) { Count = 4096; }
    if (opt === void 0) { opt = Option_1.Option; }
    return (0, http_1.default)(opt).get("".concat(opt.baseUrl, "/SCAN-null?Cursor=").concat(Cursor, "&Match=").concat(encodeURIComponent(Match), "&Count=").concat(Count));
};
exports.scan = scan;
var keys = function (Pattern, opt) {
    if (opt === void 0) { opt = Option_1.Option; }
    return (0, http_1.default)(opt).get("".concat(opt.baseUrl, "/KEYS-null?Pattern=").concat(Pattern));
};
exports.keys = keys;
...
exports.default = Option_1.Option;
