...
var OptionClass = /** @class */ (function () {
    function OptionClass() {
        ...
        this.rspTypeJson = function () { return _this.withUrlField("rsb", "rt~JSON"); };
        this.rspTypeJpeg = function () { return _this.withUrlField("rsb", "rt~JPG"); };
        this.rspTypeOgg = function () { return _this.withUrlField("rsb", "rt~OGG"); };
        this.rspTypeMpeg = function () { return _this.withUrlField("rsb", "rt~MPEG"); };
        this.rspTypeMp4 = function () { return _this.withUrlField("rsb", "rt~MP4"); };
        this.rspTypeText = function () { return _this.withUrlField("rsb", "rt~TEXT"); };
        this.rspTypeStream = function () { return _this.withUrlField("rsb", "rt~STREAM"); };
        //set redis DataSource of the request
        this.withDataSource = function (dataSourceName) { return _this.withUrlField("ds", "ds~" + dataSourceName); };
