    ...
    function RequestOptions() {
        ...
        this.setDefaults = function (options) {
            ...
            if (options.urlBase !== undefined) {
                exports.Option.baseUrl = options.urlBase;
            }
            if (options.JWT !== undefined) {
                if (!options.JWT)
                    ...
                    exports.Option.headers["Authorization"] = authorizationHeader;
                }
            }
            if (options.sutoken !== undefined) {
                if (!options.sutoken)
                    ...
                    exports.Option.params["su"] = options.sutoken;
            }
            if (options.primaryErrorHandler !== undefined) {
                exports.Option.primaryErrorHandler = options.primaryErrorHandler;
            }
            if (options.allowThrowError !== undefined) {
                exports.Option.throwSecondaryPromiseError = options.allowThrowError;
            }
            return _this;
        };
