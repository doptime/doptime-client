...
export default class hashKey<T> {
     ...
     */
    hSet: (Field: string | undefined, data: Partial<T>, opt?: RequestOptions) => Promise<number>;
    /**
     ...
     */
    hGet: (Field?: string, opt?: RequestOptions) => Promise<Partial<T> | null>;
    /**
     ...
     */
    hGetAll: (opt?: RequestOptions) => Promise<Record<string, Partial<T>> | null>;
    /**
     ...
     */
    hVals: (opt?: RequestOptions) => Promise<Partial<T>[]>;
    /**
     ...
     */
    hMGet: (Fields?: string[], opt?: RequestOptions) => Promise<(Partial<T> | null)[]>;
    /**
     ...
     */
    hMSet: (data: Record<string, Partial<T>>, opt?: RequestOptions) => Promise<void>;
    /**
     ...
     */
    hScan: (Cursor: number, Match: string, Count?: number, NOVALUES?: boolean, opt?: RequestOptions) => Promise<[string, string[] | Record<string, Partial<T>>]>;
    /**
