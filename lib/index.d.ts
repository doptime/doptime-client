...
export declare const sCard: (Key: string, opt?: OptionClass) => Promise<import("axios").AxiosResponse<any, any>>;
...
export declare const xRead: (Key: string, Count?: number, Block?: string, opt?: OptionClass) => Promise<import("axios").AxiosResponse<any, any>>;
