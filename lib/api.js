...
function newApi(serviceName, paramSchemaInstace, option) {
    ...
    return function (data, opt) {
        ...
        if (!!paramSchema && !(0, dataschema_1.checkSchema)(paramSchema, data))
            return Promise.reject("param not match shema of api: " + serviceName);
        return (0, http_1.default)(opt).post("".concat(opt.baseUrl, "/API-!").concat(serviceName).concat(opt.paramString()), data);
    };
}
