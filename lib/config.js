...
var RequestOptions = /** @class */ (function () {
    function RequestOptions() {
        ...
        this.getToken = function () { return null; };
        ...
        this.updateOptions = function (options) {
            ...
            ret.getToken = options.getToken || _this.getToken;
            return ret;
        };
...
var configure = function (options) {
    ...
    if (options.getToken !== undefined) {
        ...
        exports.Opt.getToken = options.getToken;
    }
    else if (options.token !== undefined) {
        // Priority 2: Static string (wrapped as function)
        if (options.token) {
            exports.Opt.getToken = function () { return options.token; };
        }
        else {
            exports.Opt.getToken = function () { return null; };
        }
    }
