...
var hashKey = /** @class */ (function () {
    function hashKey(key, dataSchemaInstace) {
        ...
        this.hScan = function (Cursor, Match, Count, NOVALUES, opt) {
            ...
            return (0, http_1.default)(opt, "arraybuffer").get("".concat(opt.baseUrl, "/HSCAN-").concat(_this.key, "?Cursor=").concat(Cursor, "&Match=").concat(encodeURIComponent(Match), "&Count=").concat(Count).concat(NOVALUES ? "&NOVALUES=true" : ""));
        };
