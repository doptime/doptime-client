...
var config_1 = require("./config"); // Assuming RequestOptions and a default Opt instance
var _1 = require(".");
    ...
    function hashKey(key, dataSchemaInstance) {
        ...
        this.hMSet = function (data, opt) {
            ...
            data.forEach(function (item) {
                for (var k in item) {
                    fields.push(k);
                    values.push((0, _1.msgpackEncode)(item[k]));
                }
            });
            return (0, http_1.default)(opt).put("".concat(opt.baseUrl, "/HMSET-").concat(_this.key, "?f=").concat(encodeURIComponent(fields.join(","))), values);
        };
        /**
