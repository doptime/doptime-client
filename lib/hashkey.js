...
var hashKey = /** @class */ (function () {
    function hashKey(key, shema) {
        if (shema === void 0) { shema = null; }
        var _this = this;
        this.key = key;
        this.shema = shema;
        this.checkShema = function (data) {
            ...
            //single value shema
            if (typeofdata != "object" && typeofdata == _this.shema)
                return true;
            //case of object shema
            for (var field in _this.shema) {
                var v = _this.shema[field];
        ...
        if (typeof shema == "object")
            for (var field in this.shema) {
                var v = this.shema[field];
                this.shema[field] = typeof v;
            }
        else
            this.shema = typeof shema;
    }
    return hashKey;
}());
