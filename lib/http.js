...
var Req = function (option, responseType) {
    ...
    req.interceptors.request.use(function (config) { return __awaiter(void 0, void 0, void 0, function () {
        var latestToken, authValue, e_1, datatype, buf, view, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, option.getToken()];
                case 1:
                    latestToken = _a.sent();
                    if (latestToken) {
                        authValue = latestToken.startsWith("Bearer ") ? latestToken : "Bearer ".concat(latestToken);
                ...
                case 2:
                    e_1 = _a.sent();
                    console.warn("[doptime] Get token failed:", e_1);
                    return [3 /*break*/, 3];
                case 3:
                    // --- New Logic End ---
                    if (config.method === "post" || config.method === "put") {
                        ...
                        if (config.data instanceof Uint8Array) {
                            buf = new ArrayBuffer(config.data.length);
