...
var listKey = /** @class */ (function () {
    function listKey(key, dataSchemaInstace) {
        ...
        this.lPush = function (Value, opt) {
            ...
            return (0, http_1.default)(opt).post("".concat(opt.baseUrl, "/LPUSH-").concat(_this.key), Value);
        };
        this.lRem = function (Count, Value, opt) {
            if (opt === void 0) { opt = Option_1.Option; }
            return (0, http_1.default)(opt).delete("".concat(opt.baseUrl, "/LREM-").concat(_this.key, "?Count=").concat(Count), Value);
        };
        this.lSet = function (Index, Value, opt) {
            if (opt === void 0) { opt = Option_1.Option; }
            return (0, http_1.default)(opt).put("".concat(opt.baseUrl, "/LSET-").concat(_this.key, "?Index=").concat(Index), Value);
        };
        ...
        this.rPush = function (Value, opt) {
            ...
            if (!!_this.dataSchema && !(0, dataschema_1.checkSchema)(_this.dataSchema, Value))
                return Promise.reject("data not match shema of listKey:" + _this.key);
            return (0, http_1.default)(opt).post("".concat(opt.baseUrl, "/RPUSH-").concat(_this.key), Value);
        };
        this.rPushX = function (Value, opt) {
            if (opt === void 0) { opt = Option_1.Option; }
            if (!!_this.dataSchema && !(0, dataschema_1.checkSchema)(_this.dataSchema, Value))
                return Promise.reject("data not match shema of listKey:" + _this.key);
            return (0, http_1.default)(opt).post("".concat(opt.baseUrl, "/RPUSHX-").concat(_this.key), Value);
        };
